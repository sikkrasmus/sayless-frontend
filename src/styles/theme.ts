...
export const colors = {
    // Brand colors
    burgundy: {
        DEFAULT: '#32181B', // Main burgundy color
        light: '#4A2A2D',
        dark: '#251214',
        hover: '#3F2023',
    },
    beige: {
        DEFAULT: '#E3C9A2', // Main beige color
        light: '#EBD8B9',
        dark: '#D4B68C',
        hover: '#DBBC91',
    },
    text: {
        primary: '#151926', // Main text color
        secondary: '#4A4B57',
        light: '#6E7081',
        muted: '#9CA3AF',
    },
    background: {
        white: '#FFFFFF',
        light: '#F9F9F9',
        overlay: 'rgba(0, 0, 0, 0.05)', // For dusty overlay effect
    },
    status: {
        success: '#10B981',
        warning: '#F59E0B',
...
export const typography = {
    fontFamily: {
        goldman: ['Goldman', 'sans-serif'], // Primary font
        inter: ['Inter', 'sans-serif'], // Secondary font for product cards
    },
    fontSize: {
        '2xs': '0.625rem', // 10px
        xs: '0.75rem',     // 12px
